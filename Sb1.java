...
public class Sb1 {
    public static int localport;// = 1723;
    public static String directory;// = "sb1_server/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, Object> Map = Reader.getValue(Sb1.class.getName());
        ...
        try (ServerSocket server = new ServerSocket(localport)) {
            ...
            while (true) {
                ...
                if (demande != null) {
                    System.out.println(demande.getClass());
                    if (demande.getClass().equals(Fichier.class)) {
                        ...
                        AddAndgivePartition(client,
                                Integer.parseInt(Reader.getValue("Sb2").get("localport").toString()),
                                Reader.getValue("Sb2").get("ip").toString(), demande);
