...
public class Sb3 {
    public static int localport; // = 1725;
    public static String directory;// = "sb3_server/";
    ...
    public static void main(String[] args) throws Exception {
        Map<String, Object> Map = Reader.getValue(Sb3.class.getName());
        ...
        try (ServerSocket server = new ServerSocket(localport)) {
            ...
            while (true) {
                ...
                if (demande != null) {
                    ...
                    // ajouter et donner la partition a MasterServer
                    else if (demande.getClass().equals(Partition.class)) {
                        AddAndgivePartition(client,
                                1999,
                                Reader.getValue("Server").get("ip").toString(), demande);
